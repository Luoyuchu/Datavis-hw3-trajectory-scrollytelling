...
let options = {
  ...
  startEvent: 'DOMContentLoaded_no', //do not automatically start
...
const initializeScroll = function initializeScroll() {
  ...
  handleScroll($aosElements, options.baseElement);

  /**
   * Handle scroll event to animate elements on scroll
   */
  options.baseElement.addEventListener(
    'scroll',
    throttle(() => {
      handleScroll($aosElements, options.baseElement);
 ...
 */
const refreshHard = function refreshHard(initialize = false) {
